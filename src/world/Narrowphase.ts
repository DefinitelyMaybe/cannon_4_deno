...
import { Vec3Pool } from "../utils/Vec3Pool.ts";
import { ContactEquation } from "../equations/ContactEquation.ts";
import { FrictionEquation } from "../equations/FrictionEquation.ts";
import type { Box } from "../shapes/Box.ts";
import type { Sphere } from "../shapes/Sphere.ts";
import type {
  ConvexPolyhedron,
  ConvexPolyhedronContactPoint,
} from "../shapes/ConvexPolyhedron.ts";
import type { Particle } from "../shapes/Particle.ts";
import type { Plane } from "../shapes/Plane.ts";
import type { Trimesh } from "../shapes/Trimesh.ts";
import type { Heightfield } from "../shapes/Heightfield.ts";
import type { ContactMaterial } from "../material/ContactMaterial.ts";
...
export const COLLISION_TYPES = {
  ...
  convexHeightfield:
    (Shape.types.CONVEXPOLYHEDRON | Shape.types.HEIGHTFIELD) as 48,
